...
//	auto pauseMenuBackground = Sprite::create("background/Splash.png"); // sprite image
...
//	this->addChild(pauseMenuBackground, -50); // add child
	...
	auto resumeButton = MenuItemImage::create("buttons/btNotResumeGame.png", "buttons/btActResumeGame.png", CC_CALLBACK_1(Pause::resume, this));
	auto mainMenuButton = MenuItemImage::create("buttons/btNotMainGame.png", "buttons/btActMainGame.png", CC_CALLBACK_1(Pause::mainMenu, this));
